...
class _BedScreenState extends State<BedScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color: Colors.white,
      padding:
          EdgeInsets.fromLTRB(screenWidth * 0.12, 30, screenWidth * 0.12, 0),
      child: Column(
        children: <Widget>[
          Center(
                  ...
                  child: Container(
                    child: ListTile(
                      ...
                      title: new Text(
                        "Bed No $index",
                        style:
                            TextStyle(fontFamily: 'B612', color: Colors.black),
                      ),
                      trailing: FlatButton(
                        color: Colors.white,
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PatientPage(patient: patients[index]),
                            ),
                          );
                        },
                      ),
